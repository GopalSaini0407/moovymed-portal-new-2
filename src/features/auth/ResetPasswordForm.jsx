...
const ResetPasswordForm = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(45deg, rgba(196,27,104,1) 0%, rgba(100,189,254,1) 50%, rgba(255,255,255,1) 100%)",
        ...
        <div className="max-w-md w-full">
          <div className="flex justify-center mb-8">
            <div className="bg-opacity-20 rounded-lg p-4">
              <img
                src="https://portal.moovymed.de/static/media/Logo-weiss.8f84ee51.svg"
                alt="Logo"
